...
class Blockchain(object):
    ...
    def new_block(self, proof, previous_hash=None):
        ...
        Work algorithm
        :param previous_hash: (Optional) <str> Hash of
        previous Block
    ...
    def new_transaction(self, sender, recipient, amount):
        """
        Creates a new transaction to go into the next mined
Block
    ...
    def hash(block):
        """
        Creates an SHA-256 hash of Block
        :param block: <dict> Block
        :return: <str>
        """

        # We must make sure that the Dictionary is Ordered, or
        # we'll have inconsistent hashes
...
def mine():
    ...
    # The sender is "0" to signify that this has mind a new coin
